...
while guesses_made < 5:
    ...
    if guess == number:
        break
if guess == number:
    print(f'Ух ты, {0}! Ты угадал мое число, использовав {1} попыток! \n'.format(name, guesses_made))
else:
    print(f'А вот и не угадал! Я загадал число {0} \n'.format(number))
end = time.time()
...
dict2 = {'красный': 'red', 'зеленый': 'green', 'синий': 'blue'}

print(dict2['красный'], dict2['синий'])

print('Работу выполнил: ', input('Как тебя зовут?: '))
